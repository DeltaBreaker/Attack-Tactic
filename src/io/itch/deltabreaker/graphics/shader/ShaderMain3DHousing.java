...
public class ShaderMain3DHousing extends Shader {

	public static float fadeDist = 36f;
	public static float transition = 8f;

	public ShaderMain3DHousing(String file) {
		super(file);
	}
	...
	public void setStaticUniforms() {
		...
		setUniform("spotlight", Startup.camera.position);
