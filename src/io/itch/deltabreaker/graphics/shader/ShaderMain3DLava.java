...
public class ShaderMain3DLava extends Shader {

	public ShaderMain3DLava(String file) {
		super(file);
	}
	...
	public void use(int sample, Material material) {
		...
		ResourceManager.textures.get("lava.png").bind(sample + 3);
		setUniform("lava", sample + 3);
