...
public class EffectBattleDarkBlast extends EffectBattle {
	...
	public EffectBattleDarkBlast(Vector3f position, boolean dir) {
	...
	public void render() {
		if (frame < frames - 1) {
			BatchSorter.add("z", "effect_battle_dark_0_" + frame + ".dae", "effect_battle_dark_0_" + frame + ".png",
					"main_3d_bloom", "DEFAULT", Vector3f.add(position, 0, 2, -6), rotation, scale, new Vector4f(1f, 1f, 1f, 1), true, false);
		}
		for (int i = 0; i < sparks.size(); i++) {
			sparks.get(i).render();
		}
